...
public class ImagePlusToObjectJConverter extends AbstractConverter<ImagePlus, BufferJ> {
    ...
    @Override
    public BufferJ convert(ImagePlus source) {
        ...
        /*if (source.getBitDepth() == 8) {
            ...
            BufferJ target = cle._native.CharPush(inputArray, (int)dimensions[0], (int)dimensions[1], (int)dimensions[2]);
            ...
            BufferJ target = cle._native.ShortPush(inputArray, (int)dimensions[0], (int)dimensions[1], (int)dimensions[2]);
            setThirdDimension(source, thirdDimension, thirdDimensionBefore);
            return target;
        } else */
        // Workaround:
        ...
        if (source.getBitDepth() == 32) {
            ...
            BufferJ target = MemoryJ.makeFloatBuffer(cle.getProcessor(), source.getWidth(), source.getHeight(), source.getNSlices(), "buffer");
            MemoryJ.writeFloatBuffer(target, inputArray, source.getWidth() * source.getHeight() * source.getNSlices());
            setThirdDimension(source, thirdDimension, thirdDimensionBefore);
            return target;
        } else {
